...
- Official Klei and Steam sources are registered as verification sources and source-audited. Steam product and DLC appdetails now retain normalized product facts, parent apps, media URLs, and entity mentions. Dedicated update and patch-note fact tables still need expansion.
